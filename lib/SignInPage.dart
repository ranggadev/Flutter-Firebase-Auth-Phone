  ...
  void _verifyPhoneNumber() async {
    ...
    final PhoneVerificationCompleted verificationCompleted = (AuthCredential phoneAuthCredential) {
      ...
      setState(() {
        ...
        print('rangga : Received phone auth credential: $phoneAuthCredential');
      });
    };
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      setState(() {
        ...
        print('rangga : Phone number verification failed. Code: ${authException.code}. Message: ${authException.message}');
      });
    };
    ...
    final PhoneCodeSent codeSent =
      ...
      print('rangga : Please check your phone for the verification code... Your verificationdId' + verificationId);
    };
    ...
    final PhoneCodeAutoRetrievalTimeout codeAutoRetrievalTimeout =
      ...
      print('rangga : Your verificationId' + verificationId);
    };
  ...
  void _signInWithPhoneNumber() async {
    ...
    setState(() {
      if (user != null) {
        ...
        //simpan user.uid ke dalam database
        //nanti pengaturan pengguna cari berdasarkan uid nya, jika ditemukan maka tampilkan profil
      } else {
